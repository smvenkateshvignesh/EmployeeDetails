...
class MainActivity : BaseActivity() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        mainModel= ArrayList()
        mainModel.add(MainModel(R.drawable.advisor,"Tharunkumar Reddy","Android Developer","101","Ongole","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",1))
        mainModel.add(MainModel(R.drawable.advisor,"Dheeraj Deevi","IOS Developer","109","Tirupathi","9483578321",33.3F,"","01 Aug 2019",1))

        mainModel.add(MainModel(R.drawable.advisor,"Tharunkumar Chittimi","Android Developer","102","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",1))
        mainModel.add(MainModel(R.drawable.advisor,"Sindhura","IOS Developer","113","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",1))
        mainModel.add(MainModel(R.drawable.advisor,"Yugandhar Vadlamudi","Android Developer","102","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",0))

        mainModel.add(MainModel(R.drawable.advisor,"Vignesh Venkatesh","Android Developer","103","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",1))
        mainModel.add(MainModel(R.drawable.advisor,"Lahari","IOS Developer","110","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",1))
        mainModel.add(MainModel(R.drawable.advisor,"Naveen Kumar","Android Developer","102","Tirupathi","9483578321",33.3F,"28 Nov 1997","01 Aug 2019",0))
